...
allHrsArray.map(element => element.style.border = `1px solid tomato`)
...
allHrsArray.map(element => element.style.borderRadius = `5px`)
...
box17.style.visibility = `hidden`

// Change the border of all the hr element from solid to dashed type

allHrsArray.map(element => element.style.borderStyle = `dashed`)
...
imgElm.src = `https://images.unsplash.com/photo-1638913970895-d3df59be1466?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2831&q=80`
