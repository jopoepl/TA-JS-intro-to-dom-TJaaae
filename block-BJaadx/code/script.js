...
console.log(`The length of ul element topics is ${ul.children.length}`)
...
allTopics.forEach(value => console.log(value.innerText))
...
console.log( `The total number of img element is ${totalImg.length}`)
